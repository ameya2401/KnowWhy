...
class QueryProcessor:
    ...
    def process(cls, query: str) -> dict:
        ...
        for token in raw_tokens:
            # Strip trailing/leading punctuation but keep internal dashes/underscores for technical words  # noqa: E501
            ...
            if (
                cleaned_token in TECHNICAL_IDENTIFIERS
                or cleaned_token.replace("-", "") in TECHNICAL_IDENTIFIERS
            ):
